...
The group is in its formation stage. The charter has been adopted and we are preparing for our first official meeting. A call for availability will be sent to the mailing list shortly.

## Participate

- **Join the group:** https://www.w3.org/community/agent-identity/
- **Mailing list:** public-agent-identity@w3.org
- **W3C Code of Conduct** applies to all participation

## Repository Structure

This repo is the entry point for the group's work. Each specification will have its own dedicated repository linked from here as work begins.
